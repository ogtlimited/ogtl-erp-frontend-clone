      ...
      <div className="tab-pane" id="tab_settings">
        <Formik
          ...
          validationSchema={Yup.object().shape({
            ...
            monthlyEmployeePension: Yup.number().required(
              "Monthly Employee Pension is required"
            ),
            CRA: Yup.number().required("CRA is required"),
            CRABonusAmount: Yup.number().required(
              "CRA Bonus Amount is required"
            ),
                ...
                <div className="form-group row">
                  <div className="col-md-6">
                    ...
                    <Field
                      ...
                      className={
                        "form-control" +
                        (errors.basic && touched.basic ? " is-invalid" : "")
                      }
                    />
                    <ErrorMessage
                      name="basic"
                ...
                <div className="form-group row">
                  <div className="col-md-6">
                    ...
                    <Field
                      ...
                      className={
                        "form-control" +
                        (errors.housing && touched.housing ? " is-invalid" : "")
                      }
                    />
                    <ErrorMessage
                      name="housing"
                ...
                <div className="form-group row">
                  <div className="col-md-6">
                    ...
                    <Field
                      ...
                      className={
                        "form-control" +
                        (errors.monthlyEmployeePension &&
                        touched.monthlyEmployeePension
                          ? " is-invalid"
                          : "")
                      }
                    />
                  ...
                  <div className="col-md-6">
                    ...
                    <Field
                      ...
                      className={
                        "form-control" +
                        (errors.CRA && touched.CRA ? " is-invalid" : "")
                      }
                    />
                    <ErrorMessage
                      name="CRA"
